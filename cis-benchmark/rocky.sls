...
# 1.1.19/1.1.20/10.1.21 nosuid/nodev/noexec/nosuid para o /home
nosuid_home:
  file.replace:
    - name: /etc/fstab
...
# 1.1.3.2/1.1.3.3 nosuid/nodev to /var
nosuid_var:
  file.replace:
    - name: /etc/fstab
...
# 1.1.5.2/1.1.5.3/1.1.5.4 ensure nosuid/noexec/nodev to /var/log
nosuid_var_log:
  file.replace:
    - name: /etc/fstab
...
# 1.1.6.2/1.1.6.3/1.1.6.4 ensure nosuid/noexec/nodev to /var/log/audit
...
####
### NÃO SERÁ FEITO AQUI (ver basic_services/auditd e basic_services/syslog-ng)
...
{% include "basic_services/journal-remote.sls" %}
